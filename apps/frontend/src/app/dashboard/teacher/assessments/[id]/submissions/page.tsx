    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          ...
          <Button variant="outline" onClick={() => router.push('/dashboard/teacher/assessments')}>Back to Assessments</Button>
        </div>
      </div>
              ...
              return (
                <tr key={sub.id} style={{ borderBottom: '1px solid var(--border)' }}>
                  ...
                  <td style={{ padding: '16px 24px', textAlign: 'right' }}>
                    <Button variant="outline" size="sm" onClick={() => router.push(`/dashboard/teacher/assessments/${assignmentId}/submissions/${sub.id}`)}>
