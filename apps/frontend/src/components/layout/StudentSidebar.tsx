    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-2.5 py-1.5 overflow-y-auto space-y-4 scrollbar-thin">
          ...
          <div className="space-y-0.5">
            ...
            <div className="space-y-0.5">
              <div
                ...
                className={`flex items-center justify-between px-2.5 py-2 rounded-xl text-xs font-medium transition-all cursor-pointer group ${
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  />
                  <span className="truncate">Community Spaces</span>
                </div>
                {communityExpanded ? (
          ...
          {/* Settings Section (Single location under PREFERENCES) */}
          <div className="space-y-0.5">
            <div className="px-2.5 py-1 text-[10px] font-bold tracking-wider text-neutral-400 uppercase">
              PREFERENCES
            </div>
            ...
            >
              <div className="flex items-center gap-2.5 min-w-0">
                <Settings className="w-4 h-4 text-neutral-400 group-hover:text-neutral-700" />
